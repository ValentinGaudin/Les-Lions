...
<section class="sectionArticles">
    ...
    <article class="positioningImage parcTeteDor ">
            <h2><a href="Articles/parctetedor.php">Parc de la tête d'or</a></h2>
    ...
    <article class="positioningImage parcParilly">
            <h2><a href="Articles/parcParilly.php">Parc de Parilly</a></h2>
    ...
    <article class="positioningImage climbUp">
            <h2><a href="Articles/climbUp.php">Climb Up</a></h2>
