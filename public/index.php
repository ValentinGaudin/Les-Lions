...
<body>
        ...
        <section class="lastArticle" >
                ...
                <article class="parcTeteDor positioningImage" >
                        ...
                        ce n’est pas sans raison. Le plus grand parc urbain de France, est une fantastique bulle d’oxygène au milieu de l’incessante agitation de la cité des Gones. 
                        Que l’on soit Lyonnais ou simple touriste, une promenade dans le Parc de la Tête d’Or ne laisse jamais indifférent :
                        Des milliers d’essences végétales, une centaine d’espèces animales et un patrimoine inestimable. Mais s’est-on déjà demandé d’où venait son nom ?</p>      
                </article>
                
                <article class="confluence positioningImage">
                        <h2><a href="/Culture/Articles/confluence.php">Le musée des Confluences</a></h2>
