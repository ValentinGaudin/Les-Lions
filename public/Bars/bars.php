...
<section class="sectionArticles">
    ...
    <article class="positioningImage">
        <a href="Articles/hardRockCafe.php">
            ...
            <img class="imageArticle" src='/images/hardRockCafe.jpeg'>
    ...
    <article class="positioningImage">
        <a href="Articles/leFlorian.php">
            ...
            <img class="imageArticle" src='/images/leFlorian.jpeg'>
    ...
    <article class="positioningImage">
        <a href="Articles/theMonkeyClub.php">
            ...
            <img class="imageArticle" src='/images/theMonkeyClub.jpeg'>
    ...
    <article class="positioningImage">
        <a href="Articles/diplomatico.php">
            ...
            <img class="imageArticle" src='/images/diplomatico.jpeg'>
