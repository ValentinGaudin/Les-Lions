...
<section class="sectionArticles ">
        ...
        <article class="positioningImage leBoeufDargent">
                ...
                <p class="description positioning">Situé dans le Vieux Lyon, Le Boeuf d’Argent et son chef Lyonnais renommé : Mr Giraud, Henri Balland proposent une cuisine maison de qualité dans un cadre intimiste et chaleureux.</p>
        ...
        <article class="positioningImage warung">
                ...
                <p class="description positioning">Bienvenue dans un monde de fraîcheur, de saveurs authentiques, dans une ambiance décontractée. Respirez profondément et embarquez pour un voyage… au cœur de l’Asie du sud-est.</p>
                <div class='article_notation'>
                <img src="/images/red-star.png">
                </div>
        ...
        <article class="positioningImage bistrotOrcia">
                ...
                <p class="description positioning">Bistrot Croix Rousse, à deux pas du Gros Cailloux, une équipe de passionnés vous accueille dans un cadre élégant et chaleureux où tout a été pensé  pour votre confort.</p>
                <div class='article_notation'>
                <img src="/images/red-star.png">
                </div>
        </article>
